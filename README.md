...
See `reviews/expert_reviews.md` for the expert-panel scientific review of the Winter Edition: an initial six-panel review (math, ML/AI, human factors, medical AI/ethics, bibliography, writing) conducted 2026-04-22, and a four-panel refresh (math, content, writing, bibliography) against the current 517-page build on 2026-06-21. All raised items are resolved.
