...
| **Winter** | `editions/winter/` | LaTeX PDF (6×9) | Main textbook: 19 chapters + appendices + teaching package |
...
The editions do not share one universal chapter table. Winter is the 19-chapter textbook with LaTeX chapters, technical appendices, teacher guides, solutions, and annotated bibliographies. Summer is a 17-chapter Jupyter Book workbook with its own taxonomy. Spring is a 15-chapter platform guide. Use each edition's `_toc.yml`, `main.tex`, or local README as the source of truth for that edition.
...
editions/
  ...
  winter/                    # LaTeX 19-chapter trade paperback
...
build/
  scripts/                   # assemble_site.sh, check_links.py, fix_translations.py, inject_html_links.py
  compat/imghdr.py           # Python 3.13 stdlib shim

dist/                        # Pre-built deliverables
  comic/                     # Comic edition assets
  reader/                    # Built reader app
...
See `reviews/expert_reviews.md` for the expert-panel scientific review of the Winter Edition: an initial six-panel review (math, ML/AI, human factors, medical AI/ethics, bibliography, writing) conducted 2026-04-22, a four-panel refresh (math, content, writing, bibliography) on 2026-06-21, and a five-panel review of the new Chapter 18 (the four standing personas plus a policy & political economy reviewer) on 2026-07-19. All raised items are resolved.
...
| Component | Status |
|-----------|--------|
| 19 Chapters (LaTeX) | Complete |
| 19 Technical Appendices | Complete |
| 38 Teaching Files (guide + solutions) | Complete |
...
The content across all editions was produced with substantial assistance from a range of AI tools, under human direction, editing, and review; the author is responsible for the final content. The translations have only been validated for English and Greek; all other language editions are machine-generated and unreviewed.
