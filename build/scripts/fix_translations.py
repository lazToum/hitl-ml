...
# Paths derive from this script's location (repo root); override with REPO_ROOT.
REPO_ROOT = os.environ.get("REPO_ROOT", os.path.dirname(os.path.abspath(__file__)))
DIST_DIR = os.path.join(REPO_ROOT, "dist", "site", "summer", "translations")
EDITIONS_DIR = os.path.join(REPO_ROOT, "editions", "summer", "translations")
LANGUAGES = ["de", "en", "es", "fa", "fr", "ru", "tr", "zh"]
