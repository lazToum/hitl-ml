...
**Path A:** Lower the threshold to 70%. Fewer cases go to humans. Less physician time is required. The AI handles more ambiguous cases independently.

**Path B:** Raise the threshold to 90%. More cases are escalated. More physician time is required. The AI handles fewer ambiguous cases independently.
...
*Ray is the engineer-adjacent voice of the companion comic series — the practitioner who came to annotation from a technical background and keeps wanting to fix the pipeline. Ray doesn't always have answers. Ray has better questions.*
