...
**Why it's wrong:** The confidence score is not a decision. It is a signal. The AI says "94% confident" because it has learned to produce that number from training data — and the training data was labeled by humans who were also operating under constraints, biases, and ambiguities. When you review an output, you are not confirming the AI's decision. You are performing an independent judgment that the AI's output is consistent with what a careful, informed human would say is correct.
...
*What's true instead:* Your job is not to approve what the AI decided. Your job is to notice when the AI's decision and your judgment diverge — and to register that divergence, even when doing so feels like slowing down. The 94% confident cases are not boring. They are where the calibration gets tested. Every approval you wave through without looking becomes one more data point telling the system its confidence scores need no correction — whether or not that was true.
...
## Misconception 4: "Human in the Loop = Anonymous Noise"
...
If you've recognized yourself in any of these misconceptions — and decided not to stop there — here are some places to look next:

- **Collective voice.** Annotation workers have organized through groups like the Alphabet Workers Union (AWU) and the Amazon Labor Union (ALU). Worker organizing is one of the few mechanisms that can shift the structural conditions this pamphlet describes.
- **Regulatory frameworks.** The EU AI Act, GDPR Article 22, and NYC Local Law 144 are not just compliance checkboxes — they create legal leverage for questioning how systems use human judgment. Knowing what the law requires of your employer or platform is part of understanding your role.
- **External audits.** Organizations like the Algorithmic Justice League and the Distributed AI Research Institute (DAIR) publish independent audits of AI systems. Reading an audit of a system similar to yours can help you recognize patterns you're too close to see.
- **Whistleblowing.** If you see systematic harm and internal channels fail, whistleblower protections exist in many jurisdictions. Document what you see. Know your rights.

You are not the ethics department. But you are also not powerless. The gap between those two statements is where the real work happens.
...
*— L.G.T., Petroupolis, written Spring 2026*
