...
*Core references: [@ratner2017snorkel; @snow2008cheap; @pustejovsky2012natural].*

<!-- html-link-injected -->
```{only} latex
*Interactive version (word search, games):* open `summer_interactive/chapters/09_nlp.html` from the accompanying zip archive.
```
