...
*Core references: [@russakovsky2015imagenet; @lin2014microsoft; @kirillov2023segment].*

<!-- html-link-injected -->
```{only} latex
*Interactive version (word search, games):* open `summer_interactive/chapters/10_vision.html` from the accompanying zip archive.
```
