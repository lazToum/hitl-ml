...
*Core references: [@rajpurkar2017chexnet; @begoli2019uncertainty; @kompa2021second].*

<!-- html-link-injected -->
```{only} latex
*Interactive version (word search, games):* open `summer_interactive/chapters/11_healthcare.html` from the accompanying zip archive.
```
