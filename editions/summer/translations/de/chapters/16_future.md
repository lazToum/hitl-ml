...
```{seealso}
Skalierbare Aufsicht und Debatte: {cite}`bowman2022measuring`. Snorkel schwache Überwachung: {cite}`ratner2017snorkel`. Für die breite Zukunft der Mensch-KI-Zusammenarbeit, siehe {cite}`amershi2014power`.
```
