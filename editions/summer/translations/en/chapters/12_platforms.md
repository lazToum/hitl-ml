...
The full pipeline — unlabeled data in, deployed model out — fits together as follows:
...
```{seealso}
For Label Studio documentation and active learning integration, see the official Label Studio documentation. For Prodigy, see the Prodigy documentation. For CVAT, see the CVAT documentation. For a comprehensive comparison of annotation tools, see {cite}`monarch2021human`, Chapter 7.
```
