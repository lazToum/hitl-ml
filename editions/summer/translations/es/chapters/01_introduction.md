...
Esta definición incluye los flujos de anotación clásicos, el aprendizaje activo, el aprendizaje automático interactivo, RLHF y el aprendizaje por imitación. Excluye la recopilación de datos pasiva y el aprendizaje supervisado puramente fuera de línea (aunque la línea es difusa, como se discutirá en el Capítulo 2).
...
En dominios de alto riesgo —medicina, derecho, finanzas— las decisiones deben ser responsables ante los seres humanos. Los sistemas HITL hacen que esta rendición de cuentas sea viable al mantener a los humanos en posición de comprender, verificar y anular el comportamiento de las máquinas.
...
|   ---------------------------------->       |
|                                   Humano   |
|   El humano proporciona retroalimentación < |
|   ----------------------------------        |
|                                             |
|   El modelo actualiza con retroalimentación |
|                                             |
+---------------------------------------------+
```
...
| Preferencia               | "La respuesta A es mejor que la B"                     | RLHF / ranking              |
...
**HITL no es lo mismo que el despliegue con humano en el bucle** (a veces llamado "humano sobre el bucle"), donde los humanos supervisan decisiones automatizadas y pueden anularlas, pero no retroalimentan correcciones al entrenamiento. Trataremos esta distinción en el Capítulo 2.
