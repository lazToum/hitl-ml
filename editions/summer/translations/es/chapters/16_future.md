...
```{seealso}
Supervisión escalable y debate: {cite}`bowman2022measuring`. Supervisión débil con Snorkel: {cite}`ratner2017snorkel`. Para el futuro amplio de la colaboración humano-IA, véase {cite}`amershi2014power`.
```
