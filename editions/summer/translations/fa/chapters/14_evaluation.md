...
CheckList ارزیابی انسانی را هدفمند و قابل عمل می‌کند: به‌جای یک عدد دقت واحد، نمایه‌ای از قابلیت‌ها ارائه می‌دهد. ابزارهایی مانند Polyjuice {cite}`wu2021polyjuice` تولید خودکار موارد آزمون متقابل (counterfactual) را برای این نوع کاوش ممکن می‌سازند.
