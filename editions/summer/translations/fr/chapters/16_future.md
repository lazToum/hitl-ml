...
```{seealso}
Supervision évolutive et débat : {cite}`bowman2022measuring`. Supervision faible Snorkel : {cite}`ratner2017snorkel`. Pour l'avenir large de la collaboration humain-IA, voir {cite}`amershi2014power`.
```
