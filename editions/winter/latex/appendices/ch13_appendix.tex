...
The bias $c$ and the criterion location $k$ are related by $c = k - d'/2$, so $c = 0$ places the criterion midway between the noise and signal means (unbiased), independent of where $k$ itself sits.
