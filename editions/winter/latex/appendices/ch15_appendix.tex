...
\chapter*{Technical Appendix 15A: Error Analysis Frameworks}
\addcontentsline{toc}{chapter}{Technical Appendix 15A: Error Analysis Frameworks}
\label{app:ch15}
...
def compute_slice_metrics(df, slice_col, target_col, pred_col,
    ...
    return df.sort_values('gap_from_baseline')
\end{lstlisting}

% ============================================================================
\section{Behavioral Testing: The CheckList Methodology}
% ============================================================================
...
% ============================================================================
\section{Data Debugging with Influence Functions}
% ============================================================================
...
% ============================================================================
\section{Inter-Annotator Agreement Metrics}
% ============================================================================
...
\begin{table}[h]
\centering
\caption{Kappa interpretation for HITL annotation quality. Agreement labels follow the Landis--Koch scale~\autocite{landis1977kappa}; the action column is the HITL-specific overlay.}
\label{tab:kappa-interpretation}
\begin{tabularx}{\textwidth}{@{}llY@{}}
\toprule
\textbf{Kappa Range} & \textbf{Agreement} & \textbf{HITL Action} \\
\midrule
$> 0.80$ & Almost perfect & Proceed with training \\
$0.61$--$0.80$ & Substantial & Review guidelines for ambiguous cases \\
$0.41$--$0.60$ & Moderate & Revise guidelines; additional annotator training \\
$\leq 0.40$ & Slight to fair & Halt training; redesign annotation process \\
\bottomrule
\end{tabularx}
\end{table}

% ============================================================================
\section{The HITL Debugging Workflow}
% ============================================================================

The five tools above are most powerful when used in sequence:
