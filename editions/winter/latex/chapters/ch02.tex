...
So consider a reader who opened a file her department's new AI screening tool had flagged, and the flag made no sense. The image looked routine---a middle-aged woman with mild bilateral infiltrates, consistent with early-stage pneumonia. She would have classified it quickly, prescribed antibiotics, and moved on. But the AI had attached a confidence score of 51~percent.

That number stopped her. Fifty-one percent was not a diagnosis---it was a coin flip. The system was not telling her it had found something; it was telling her it genuinely did not know what it was looking at. She looked more carefully, and ordered a follow-up CT scan. The CT revealed a rare fungal infection---\emph{Pneumocystis jirovecii} pneumonia---which mimics bacterial pneumonia on a plain X-ray but requires completely different treatment. In immunocompromised patients, the distinction is life or death.

Had the AI announced ninety percent confidence and a tidy diagnosis, a quick glance and a signature might have followed. The low score is what forced the second look.
...
Paul Graham, the programmer who helped develop some of the earliest effective spam filters, described the core challenge this way~\autocite{graham2002spam}: it's not the obvious spam that's hard. It's the emails in the middle.
...
A 2020 study of five leading commercial speech-recognition systems documented this failure directly \autocite{koenecke2020racial}. Averaged across the systems, the word error rate was about 19~percent for white speakers but roughly 35~percent for Black speakers---nearly double---a gap driven by speech patterns underrepresented in the training data, including African American Vernacular English.
...
There's a version of that story that seems to point in the wrong direction. After reading about the 51-percent confidence flag, you might think: ``Lower confidence threshold means more human review.'' But that logic hits a wall quickly.
