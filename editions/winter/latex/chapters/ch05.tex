...
Researchers studying out-of-hospital cardiac arrest in Dallas recommended a small change to the dispatch protocol: don't ask ``Is he breathing?'' Ask ``Is he breathing \emph{normally}?''---and, when the answer is unclear, have the caller describe each breath or hold the phone to the patient so the dispatcher can hear for themselves.

The word ``normally'' did the work. It forced the caller to judge the \emph{quality} of the breathing rather than answer a yes/no question they had already half-answered in their head. A gasping, agonal breath is many things, but it is not normal---and once a caller is asked to make that comparison, they hesitate, they describe what they see, and the dispatcher can recognize the arrest.
...
One word. One word in a question that dispatchers ask hundreds of times a day changed how callers understood what they were being asked---and changed what information the dispatchers got back.
...
Return to the dispatcher's question. One word---``normally''---changed how often a cardiac arrest was recognized in time.

Why did ``normally'' matter so much?
...
The revised question (``Is he breathing \emph{normally}?'') asked for a judgment rather than a fact. It made the caller compare what they were seeing against what breathing is supposed to look like---and agonal gasping fails that comparison. The added word turned a reflexive ``yes'' into an act of observation.
