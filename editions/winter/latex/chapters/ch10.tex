...
Judge Castel imposed sanctions on both attorneys. In his ruling, he wrote something that should be printed on the login screen of every AI assistant: ``The Court is presented with an unprecedented circumstance --- a submission replete with citations to non-existent cases.''~\autocite{mata2023avianca}
...
Research into hallucination rates is sobering. A 2024 Stanford study found that general-purpose language models hallucinated on 58\% to 82\% of legal queries \autocite{dahl2024large}. A companion study of \emph{purpose-built} legal research tools---systems explicitly marketed as nearly hallucination-free---found that even these still fabricated information between roughly 17\% and 33\% of the time \autocite{magesh2024hallucination}. Across medical domains, studies of AI diagnostic outputs have found clinically significant error rates that vary widely by task and patient population \autocite{kompa2021second}. Even retrieval-augmented systems --- models that can look things up --- hallucinate at measurable rates.
