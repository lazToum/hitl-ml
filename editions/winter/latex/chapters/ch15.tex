...
A systematic review of clinical decision support found alert override rates running as high as 96\%---across the studies surveyed, clinicians dismissed between 46\% and 96\% of the alerts they received \autocite{poly2020override}. When every signal is noise, the actual signals disappear.
\end{cautionbox}
