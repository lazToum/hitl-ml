...
The students who improve fastest are the ones who learn to close that gap---not by knowing more, exactly, but by locating their uncertainty precisely. Most learners arrive with questions they already know the answer to, designed to hear the attending physician say ``yes, you're right''---a way of seeking reassurance rather than knowledge. The more useful question sounds different: ``I think it is likely A or B. I have ruled out C for this reason. What I do not know is whether this presentation is consistent with D---is that worth pursuing?'' Not ``I do not know''---that is too vague to be actionable. Not ``I know''---that forecloses learning. But ``I know A and B and C, and the specific thing I do not know is X''---that is a question a teacher can answer.
