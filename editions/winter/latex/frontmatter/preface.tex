...
This does not mean humans are always right, or that human review always improves outcomes. The data are more complicated than that. Chapter 13 examines what the research actually shows about when human oversight helps and when it introduces new errors. The answer is not ``always'' and not ``never.'' It depends on how the system is designed.

\medskip

A note, finally, on how this book was made---because the method is a small demonstration of the thesis. It was written in a human-in-the-loop collaboration: a human author working with an AI system, in the almost-autonomous arrangement Chapter~17 describes---long stretches of capable independent work, punctuated by checkpoints where the human verified what had accumulated and corrected course. The loop caught real failures. Early drafts contained references that looked authoritative and did not exist; removing them took a citation-by-citation audit and repeated rounds of external expert review---each round a deliberately designed intervention, in the Chapter~5 sense, rather than a formality. The experience was the thermostat's lesson relearned at the author's own desk: confidence is not correctness, and the difference is only visible to a reviewer who checks. This book does not claim its loop was perfectly calibrated. It claims the calibration was attempted, measured, and revised---which is all it asks of any system it evaluates. Any errors that remain slipped past every checkpoint but one: the reader. The author would rather hear about them than not.

\medskip

The Winter edition is the full technical treatment of the ideas introduced across this project. It includes nineteen chapters, nineteen technical appendices with reference implementations, a complete teaching package, and a glossary. It is intended for use in courses on machine learning, human-computer interaction, AI ethics, or any setting where the question of how humans and AI systems should work together deserves more than a paragraph.
