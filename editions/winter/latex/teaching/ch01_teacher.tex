...
\begin{itemize}
    ...
    \item Explain the difference between aleatoric and epistemic uncertainty (introduced in Appendix~1A; covered fully in Chapter~2)
...
Timing & When does it ask? & After a few episodes or roughly 90 minutes (varies by device) \\
...
Emphasize that systems can fail in three ways:
\begin{enumerate}
    ...
    \item \textbf{Asking badly} $\rightarrow$ The Nest thermostat problem (interrupts at the wrong time, in the wrong way)
\end{enumerate}
...
\paragraph{The Three Failure Modes.}
\begin{itemize}
    \item Asking too often $\rightarrow$ Alert fatigue
    \item Never asking $\rightarrow$ Overconfidence
    \item Asking badly $\rightarrow$ The Nest problem
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Chapter 4:} Turning a probability into a decision---thresholds, error costs, and the value judgments they embed
...
0:37--0:45 & Three failure modes discussion & Whiteboard diagram \\
