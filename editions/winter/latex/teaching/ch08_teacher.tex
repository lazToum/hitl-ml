...
\begin{itemize}
    \item Present clearly: the system detected her 5.6 seconds before impact, but the classification kept flipping --- vehicle, unknown object, bicyclist --- discarding its tracking history each time; it never settled, never classified her as a pedestrian, and never predicted her path
...
\begin{itemize}
    ...
    \item \textbf{Chapter 7}: Iterative guideline revision for preference annotation --- the annotation-quality foundation that Component 5 feedback strategies such as RLHF depend on
\end{itemize}
