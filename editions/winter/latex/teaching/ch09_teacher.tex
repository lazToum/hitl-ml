...
SageMaker GT & Cloud & AWS ML integration & Existing AWS deployments only --- closing to new customers July 2026; do not adopt for new projects \\
...
\begin{itemize}
    ...
    \item Scale AI is the right choice when you need managed annotator workforce --- with a caveat: after Meta's June 2025 purchase of a 49\% stake, several large customers pulled back, so weigh Scale's independence as a vendor
    \item SageMaker Ground Truth is closing to new customers in July 2026 (no new features planned) --- fine for existing AWS deployments, but steer new projects elsewhere; a live lesson in vendor churn
\end{itemize}
