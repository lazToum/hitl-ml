...
\midrule
Model accuracy and calibration & Is the model right, and does confidence mean what we think? & Routing decisions based on bad confidence scores \\
...
Reviewer agreement rate & Do reviewers agree with each other? & Distribution shift and fatigue that look like stable performance \\
...
Use this table as a diagnostic tool. Present a scenario (the 400-reviews-per-hour case is perfect), ask students which dimension is missing, and have them predict what goes wrong. The 400-reviews case involves missing error-rate-by-pathway and audit tracking, which hid gaming-induced quality degradation --- Goodhart's Law operating at the reviewer level. (Fatigue is a separate failure mechanism covered in the vigilance-curve material; instructors who want to extend the scenario can ask students how a fatigue curve would compound the gaming problem.)
\end{technote}
