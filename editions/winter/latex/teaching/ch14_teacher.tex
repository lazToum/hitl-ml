% ============================================================================
% CHAPTER 14 TEACHER'S MANUAL
% Complete instructional guide for building fair and ethical systems
% ============================================================================
% Note: This file is for the Instructor's Edition, not the main book
% ============================================================================

\chapter{Teacher's Manual: Chapter 14}
\label{ch:teacher-ch14}

\begin{chapterquote}{Complete instructional guide}
Teaching fairness, accountability, and the limits of human oversight using \emph{Building Fair and Ethical Systems}.
\end{chapterquote}

% ============================================================================
\section*{Instructor Overview}
% ============================================================================
...
\textbf{Prerequisites:} Students should have read Chapter 7 (annotation and labeling) and Chapter 2 (calibration and uncertainty). The technical appendix material on fairness metrics is optional for non-technical courses.
...
\subsection*{Opening Discussion (15 minutes, pre-lecture)}
...
\subsection*{On the Layers of Bias}
...
\subsection*{On the COMPAS Case and Fairness Impossibility}
...
\subsection*{On the Limits of Human Oversight}
...
\textbf{Q10:} The chapter warns that under the wrong organizational conditions, ``human review provides accountability theater rather than genuine oversight.'' What organizational conditions make this outcome---humans providing legitimizing cover rather than genuine oversight---most likely? What conditions would make genuine oversight more likely?

\subsection*{On Accountability Design}
...
\textbf{Q12:} The EU GDPR (Articles 13--15) establishes transparency rights for automated decisions, often described as a ``right to explanation.'' What would a genuinely informative explanation look like for each application in Q11? What would a formally compliant but practically useless explanation look like?

\subsection*{Synthesis and Application}
...
\subsection*{Activity 1: The Hiring Algorithm Design Challenge (30 minutes)}
...
\subsection*{Activity 2: Role-Play Scenario---The Parole Board (25 minutes)}
...
\subsection*{Activity 3: The Audit Simulation (45 minutes, computer lab)}
...
\subsection*{Short Essay (500--800 words): ``Choose a Fairness Definition''}
...
% ============================================================================
\section*{Common Misconceptions to Address}
% ============================================================================
...
\begin{description}
    ...
    \item[Chapter 7] Annotation bias is a direct extension of the human judgment issues in Chapter 7; demographic homogeneity of annotator pools is a fairness issue as well as a quality issue.
    ...
    \item[Chapter 19] The civic participation theme in Chapter 19 connects directly to the question of who should make normative choices about fairness definitions.
\end{description}

% ============================================================================
\section*{Sample 50-Minute Lesson Plan}
% ============================================================================
