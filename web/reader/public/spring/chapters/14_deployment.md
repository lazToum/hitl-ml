...
**1.** The docker-compose.yml starts six services: postgres, Zitadel, rust-api, python-ai, redis, and the web assets server. What is the minimum set needed to run a hunt with one player? What could you cut?
