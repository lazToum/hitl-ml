...
*Core references: [@uma2021learning; @geva2019annotator; @pustejovsky2012natural].*

<!-- html-link-injected -->
```{only} latex
*Interactive version (word search, games):* open `summer_interactive/chapters/03_annotation.html` from the accompanying zip archive.
```
