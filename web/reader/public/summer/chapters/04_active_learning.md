...
*Core references: [@settles2009active; @lowell2019practical; @cohn1994improving].*

<!-- html-link-injected -->
```{only} latex
*Interactive version (word search, games):* open `summer_interactive/chapters/04_active_learning.html` from the accompanying zip archive.
```
