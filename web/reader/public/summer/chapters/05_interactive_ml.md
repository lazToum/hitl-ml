...
Teachable Machine [@amershi2014power] makes the feedback loop visible in a way that most ML systems do not. You can see your examples, retrain, and watch the model change. What it teaches, if you pay attention, is that a model trained only on your examples reflects only your examples.
