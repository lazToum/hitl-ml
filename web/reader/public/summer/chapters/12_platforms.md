...
*Core references: [@amershi2019software; @lingren2014evaluating].*

<!-- html-link-injected -->
```{only} latex
*Interactive version (word search, games):* open `summer_interactive/chapters/12_platforms.html` from the accompanying zip archive.
```
