...
In a growing number of jurisdictions, human review of algorithmic hiring decisions is becoming a legal requirement — New York City's Local Law 144 (2023) and the EU AI Act are two prominent examples, and in the US, "disparate impact" under Title VII of the Civil Rights Act provides a legal framework for challenging biased outcomes even without intent. But it is more than compliance: it's the mechanism by which someone can ask: is the pattern the model learned a pattern worth keeping?
