...
That approach is changing, for a reason you can see clearly in that radiologist's story: the inside of the model is often the most important thing a human needs to know.
...
In 2020, researchers at Stanford published a study of five leading commercial speech-recognition systems that documented this failure directly. Averaged across the systems, the word error rate was about 19 percent for white speakers but roughly 35 percent for Black speakers — nearly double — a gap driven by speech patterns underrepresented in the training data, including African American Vernacular English.
...
There's a version of that radiologist's story that seems to point in the wrong direction. After reading about the 51-percent confidence flag, you might think: "Lower confidence threshold means more human review." But that logic hits a wall quickly.
