...
When the toxicity detection field began systematically measuring annotator agreement, the results were sobering. A landmark study of the OLID benchmark by Zampieri and colleagues in 2019 applied rigorous annotator training and found a Fleiss' kappa of 0.83 across a trial of 21 posts. But subsequent annotation projects in the toxicity domain with larger, less-controlled annotator pools have often reported substantially lower values — sometimes in the 0.45–0.60 range — illustrating how sensitive inter-annotator agreement is to annotator composition and task framing. At the lower end — "moderate agreement" — two annotators looking at the same comment would disagree about a quarter of the time. A model trained on such data is not learning to detect toxicity; it is learning to predict the label distribution of a specific group of annotators working under specific conditions, and generalizing that distribution as if it were a fact about language.
...
The demographic composition of the annotator pool also shapes labels in systematic ways. Research led by Maarten Sap and colleagues at the University of Washington found that tweets containing African American English (AAE) were up to twice as likely to be labeled offensive compared to similar tweets in Mainstream American English — including language that was neutral or positive in context. When annotators were primed with information about AAE dialect features before labeling, the racial bias in their labels decreased. Subsequent work ("Annotators with Attitudes," 2022) confirmed that Black and white annotators differ substantially in their toxicity judgments. This was not a deliberate choice by the annotators. It was an artifact of cultural familiarity: annotators tend to be more sensitive to toxic language in registers and dialects they know well, and less sensitive in registers and dialects they are less familiar with.
