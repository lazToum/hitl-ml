...
Medical educators have a name for one of the hardest things to teach: *calibration* — the fit between how much a trainee knows and how much they believe they know. Track students through clinical-reasoning tasks and the two come apart easily; early students are frequently miscalibrated, confident where they should hesitate and hesitant where they are in fact right.

The students who improve fastest are the ones who learn to close that gap — not by knowing more, exactly, but by locating their uncertainty precisely. Most learners arrive with questions they already know the answer to, designed to hear the attending physician say "yes, you're right" — a way of seeking reassurance rather than knowledge.

The more useful question sounds different: "I think it's likely A or B. I've ruled out C for this reason. What I don't know is whether this presentation is consistent with D — is that worth pursuing?" That student is asking about her uncertainty — not what to think, but the specific, bounded regions of her knowledge where she needs input. Not "I don't know" — that's too vague to be actionable. Not "I know" — that forecloses learning. But "I know A and B and C, and the specific thing I don't know is X" — that's a question a teacher can answer.
...
This is what the best medical students learn to do. They weren't fully autonomous — they still had things to learn. They weren't dependent on supervision for everything — they handled most cases on their own. They were almost-autonomous: capable and independent in their areas of competence, precise and honest about their areas of uncertainty.
...
*In the next chapter, we turn from how the loop works to a question this book has so far left standing: who owns it — the data, the models, the labor, and the access.*
